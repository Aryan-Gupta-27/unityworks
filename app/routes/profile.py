...
from app.constants import ALLOWED_IMAGE_EXT, EXPERIENCE_LEVELS
from app.extensions import db
from app.models import Community, CommunityMember, Project, ProjectMember, User
...
def edit():
    ...
    return render_template("profile/edit.html", errors=errors, levels=EXPERIENCE_LEVELS)
...
def view(username):
    ...
    return render_template("profile/view.html", user=user, communities=communities, projects=projects)
